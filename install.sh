...
manage_ssh_users_menu() {
    ...
    source /home/ubuntu/SOCKS5PRO-main/SOCKS5PRO-main/new_ssh_user_management.sh &>/dev/null # Redireciona stdout e stderr para /dev/null
    ...
    while true; do
        ...
        # Adiciona uma pausa apenas se a opção não for sair ou uma opção inválida
