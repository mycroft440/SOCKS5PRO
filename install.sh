...
install_proxy_single_command() {
    ...
    sudo mv SOCKS5PRO/new_ssh_user_management.sh $PROJECT_DIR/new_ssh_user_management.sh || error_exit "[ERRO] Falha ao mover new_ssh_user_management.sh.\n"
...
main_menu() {
    while true; do
        ...
        case $choice in
            ...
            2) 
                sudo bash $SSH_USER_MANAGEMENT_SCRIPT
                ;;
            3) show_status ;;
